...
class CarDetection extends StatelessWidget {
...
class CarDetectionScreen extends StatefulWidget {
  @override
  CarDetectionScreenState createState() => CarDetectionScreenState();
}

class CarDetectionScreenState extends State<CarDetectionScreen> with TickerProviderStateMixin {
  bool _loading = true;
  File _image;
  List _output;
